...
!=======Changed=========
            case(ir_prot_wk_neut) ! p + mu_bar = n + e+
               r = y(prot)
               dr1 = 1
               call do_one_one(n, dydt, eps_nuc_MeV, i, 1d0, prot, r, 1d0, neut, &
                  prot, dr1, &
                  deriv_flgs, symbolic, just_dydt)
               return

            case(ir_neut_wk_prot) ! n + mu = p + e-
               r = y(neut)
               dr1 = 1
               call do_one_one(n, dydt, eps_nuc_MeV, i, 1d0, neut, r, 1d0, prot, &
                  neut, dr1, &
                  deriv_flgs, symbolic, just_dydt)
               return
!====================================
