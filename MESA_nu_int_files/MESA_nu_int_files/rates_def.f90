...
! ***********************************************************************
      ...
      ! weak
         ...
         type :: table_c
            class(weak_rate_table), pointer :: t
         end type table_c
...
!======Changed======
         integer, parameter :: ir_prot_wk_neut = ir_al26_2_to_al26_1 + 1
         integer, parameter :: ir_neut_wk_prot = ir_prot_wk_neut + 1
!         integer, parameter :: num_predefined_reactions = ir_al26_2_to_al26_1
         integer, parameter :: num_predefined_reactions = ir_al26_2_to_al26_1 + 2
!==================
      ...
      subroutine reaclib_init(jina_reaclib_filename)
         ...
         if (len_trim(reaclib_filename) == 0) &
            reaclib_filename = 'jina_reaclib_results_v2.2'
