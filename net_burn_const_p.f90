...
! ***********************************************************************
      ...
      subroutine burn_1_zone_const_P( &
         ...
         rpar(r_burn_const_P_pressure) = exp10_cr(log10Ps_f1(1)) ! no interpolation yet
         ...
         subroutine burn_jacob( &
            ...
            real(dp) :: &
                  abar, zbar, z2bar, ye, mass_correction, sumx, T, logT, &
...
!========================
            ...
            call basic_composition_info( &
               num_isos, g% chem_id, x, xh, Y, z, abar, zbar, z2bar, ye, mass_correction, sumx)
...
!=====Changed below, added zero array and first false as dummy args===
            ...
            call eval_net( &
                  neu_reac_info, netinfo, g, rates_only, skip_jacobian, &
                  .false., num_isos, &
                  num_reactions, g% num_wk_reactions, &
                  x, T, logT, rho, logRho, &
